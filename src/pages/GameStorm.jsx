...
import GameStormImg from '../assets/GameStorm.webp';
...
const GameStorm = () => {
  ...
  const handleRegisterClick = () => {
    window.open("https://docs.google.com/forms/d/e/1FAIpQLSevQ-JSVd3Si2iuNhpo5jTasR33YT1f6i6RuMLMYIehkTlxig/viewform", "_blank");
  };
        ...
        {/* Content Container */}
          <div className="relative z-10 container mx-auto m-0 pb-0 mb-0 p-10 h-full sm:h-[50vh] md:h-[70vh]">
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-center items-center text-center h-full space-y-10">
              <h1 className="text-5xl md:text-6xl font-bold text-white">GameStorm</h1>
